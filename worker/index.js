...
function mathNotation(value){
 ...
 const tokens=source.match(/arcsin|arccos|arctan|overline|sqrt|root|norm|sin|cos|tan|sec|csc|cot|log|ln|exp|abs|vec|pi|\d+(?:\.\d+)?|[A-Za-zα-ωΑ-Ωπ∞±(),+\-*/^√]/g)||[];
 ...
 try{const tree=sum();return pos===tokens.length?'math:'+JSON.stringify(tree):fallback()}catch{return fallback()}
}
